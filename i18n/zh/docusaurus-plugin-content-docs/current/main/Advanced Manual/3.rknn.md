...
本章分为四个部分：
- 下载 RKNN 相关仓库
- PC端安装RKNN-Toolkit2 环境
- 开发板端安装编译工具
- 安装板端 RKNPU2 环境

### 3.3.1 下载 RKNN 相关仓库

PC端建议新建一个目录用来存放 RKNN 仓库，例如新建一个名称为 Projects 的文件夹，并将 RKNN-Toolkit2
...
```
![Miniconda3](/img/advanced_manual/miniconda3.png)

##### 3.3.2.1.2 使用 Miniconda3 Conda 创建 Python 环境
...
```
(toolkit2) lhd@armsom:~/customized_project/Projects/rknn-toolkit2/rknn-toolkit2$ python3
