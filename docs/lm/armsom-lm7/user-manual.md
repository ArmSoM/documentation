...
For the first time using the ArmSoM-W3 development kit, please first get familiar with the [Peripheral Interfaces](./introduction#armsom-LM7-development-kit-armsom-w3) to better understand the subsequent content.
